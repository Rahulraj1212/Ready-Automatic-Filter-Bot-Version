...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('✪ Support Channel', url="https://t.me/Get_Update_Official"),
                    InlineKeyboardButton('⌬ Movies Channel', url="https://t.me/Movies_Update001")
                ],[
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("https://te.legra.ph/file/6c6e66f11b1ae1b02ad57.gif") 
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("My Owner", url="t.me/Harsh_Kumar0001")
                         ]
                        ]
                    )
                )
        ...
        for file in files:
            ...
            msg = await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     [
                      InlineKeyboardButton('Support Channel', url=f'https://t.me/{SUPPORT_CHAT}'),
                      InlineKeyboardButton('Update Channel', url=CHNL_LNK)
                   ],[
                      InlineKeyboardButton("My Owner", url="t.me/Harsh_Kumar0001")
                     ]
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n1. Add Me in Your Group with Full Admin Rights\n\n2. After Adding in Grp, Set your Shortener\n\nSend this command in your group\n\n⭕️ /shortlink ""(your_shortener_website_name) (your_shortener_api)\n\nSample One :-\n\n/shortlink onepagelink.in bb169dcd813ab28f6e8cbc12ee30725a149d0163\n\nThat's it!!! Enjoy Earning Money 💲\n\n You Can Use This Also or Any other\n\nIf you have any Doubts, Feel Free to Ask me - @Harsh_Kumar0001\n\n(If you don't understand, message me Here - @Harsh_Kumar0001)</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\nGive me a shortener website link and api along with the command !\n\nFormat: <code>/shortlink onepagelink.in bb169dcd813ab28f6e8cbc12ee30725a149d0163</code></b>")
